...
const mockAgents = [
  { id: 'iris', name: 'iris', emoji: '🧠', title: 'AI Assistant', status: 'idle' as const, current_task: '', message_count: 0 },
  { id: 'codey', name: 'Codey', emoji: '💻', title: 'Code Agent', status: 'idle' as const, current_task: '', message_count: 0 },
]
