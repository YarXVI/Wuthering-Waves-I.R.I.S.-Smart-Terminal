...
Context chunk storage with LRU caching and persistence.
"""
import json
import threading
import time
...
class ChunkStore:
    ...
    def __init__(
        ...
        self.storage_dir = Path(storage_dir) if storage_dir else Path.home() / ".iris" / "chunks"
